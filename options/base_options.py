...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--output_nc', type=int, default=40, help='# of output image channels')
        ...
        # for generator
        parser.add_argument('--netG', type=str, default='scatter', help='selects model to use for netG (pix2pixhd | spade)')
